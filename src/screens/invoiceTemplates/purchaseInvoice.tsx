...
import { purchaseInvoiceTemplatesData } from '../../utils/data/invoiceTemplatesData';
    ...
    return (
        <View>
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                {purchaseInvoiceTemplatesData.map((data, index) => {
                    return (
                        <View key={index} style={{ marginVertical: 6 }}>
                            <View >
                                <View style={{ backgroundColor: 'white', borderRadius: 5, borderWidth: 1, borderColor: '#D9E0E9', width: itemWidth }}>
                                    ...
                                    <Text style={[commonStyles.h14blackOne500,alignSelfCenter, mv5]}>{data.inVoiceType}</Text>
                                </View>
                            </View>
                        </View>
                    );

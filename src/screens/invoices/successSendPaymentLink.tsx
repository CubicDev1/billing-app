...
const SuccessSendPaymentLink = (props: successSendPaymentLinkProps) => {
    ...
    return (
        <View style={[flex1, bg_color_white, justifyCenter, alignItemCenter]}>
            ...
            <Text style={[commonStyles.h18BlackOne700,{}]} >{labels.paymentLinkSuccessfully}</Text>
            <Text style={[commonStyles.h15blackTwo400,mv5,textAlignCenter]} >{"Payment link has been send to email"}</Text>

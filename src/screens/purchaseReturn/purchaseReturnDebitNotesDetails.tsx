...
interface PurchaseReturnDebitNotesDetails {
    _id: string;
...
const PurchaseReturnDebitNotesDetails = ({ route }: any) => {
    // Extract invoiceDetails from route.params
    const [invoiceDetails, setViewDetailsData] = useState<PurchaseReturnDebitNotesDetails | null>(null);
    ...
    const ViewPurchaseData = () => {
        try {
            getMethod(
                ApiUrl.viewPurchaseReturn + route.params.itemId,
                success => {
                    if (success.code === 200) {
            ...
            <SafeAreaView style={getMainContainerStyle(false)}>
                <View style={[flex1]}>
                    <View style={[mh15, mv10]}>
                        <TopHeader headerText={labels.debitNotesDetails} />
                    </View>
                                ...
                                <View>
                                    <View style={[{ paddingVertical: 10, width: '100%', backgroundColor: colors.white, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.50, shadowRadius: 3.84, elevation: 2, borderRadius: 8 }, justifyCenter]}>
                                        <View style={[flexRow, justifyBetween, alignItemCenter,]}>
                                            ...
                                            <View style={[mr10]}>
                                                <Text style={commonStyles.h14blackOne600}>Debit Note No</Text>
                                                <View style={[{ height: 40, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400, ml10]}>{invoiceDetails.debit_note_id}</Text>
                                                </View>
                                            </View>
                                        </View>
                                        <View style={[flexRow, alignItemCenter, justifyBetween, mh10, mv10]}>
                                            <View style={[flex1]}>
                                                <Text style={commonStyles.h14blackOne600}>Debit Note To</Text>
                                            </View>
                                            <View style={{ width: 10 }} />
                                            <View style={[flex1]}>
...
export default PurchaseReturnDebitNotesDetails
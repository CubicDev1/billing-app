...
const Purchases = () => {
    ...
    const addPress = () => {
        (navigation as any).navigate(screenName.AddPurchases, { isAddedProductAvailable: false } as never)
    }
            ...
            <SafeAreaView style={getMainContainerStyle(false)}>
                <View style={[flex1]}>
                    <View style={[flex1, { backgroundColor: colors.whiteTwo }]}>
                        <View style={mh15}>
                            <View style={mv15}>
                                <TopHeader headerText={labels.purchases} />
                            </View>
                             <View style={[commonStyles.bottomWidth,mv5]}  />
                            <View style={{ marginBottom: 300 }}>
                                <ListSubHeader addIcon={true} onAddPress={addPress} listName={labels.purchases} totalNumber={total} onFilterPress={openFilterModal} />
                                <FlatList
                                    ...
                                    renderItem={({ item, index }) => {
                                        ...
                                        return (
                                            <View key={data._id}>
                                                 <TouchableOpacity style={[commonStyles.mainListCard]} onPress={() => (navigation as any).navigate(screenName.PurchasesDetails, { itemId: data._id } as never)}>
                                                    <View style={[flexRow, justifyBetween]}>
                                                        ...
                                                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                                            ...
                                                            <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                                                                <TouchableOpacity onPress={() => (navigation as any).navigate(screenName.AddPurchases, { vendorDetails: data } as any)} style={{ backgroundColor: colors.greyOne, height: 32, width: 32, borderRadius: 30, justifyContent: 'center', alignItems: 'center', marginHorizontal: 5 }}>

...
const PurchasesDetails = ({ route }: any) => {
    // Extract invoiceDetails from route.params
    const [invoiceDetails, setViewDetailsData] = useState<PurchasesDetails | null>(null);
    ...
    const ViewPurchaseData = () => {
        try {
            getMethod(
                ApiUrl.viewPurchase + route.params.itemId,
                success => {
                    if (success.code === 200) {
            ...
            <SafeAreaView style={getMainContainerStyle(false)}>
                <View style={[flex1]}>
                    <View style={[mh15, mv10]}>
                        <TopHeader headerText={labels.purchaseDetails} />
                    </View>
                                            ...
                                            <View style={[ml10]}>
                                               <Text style={commonStyles.h14blackOne600}>Date</Text>
                                                <View style={[{ height: 40, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]} >{moment(invoiceDetails.purchaseDate).format('DD MMM YYYY')}</Text>
                                                </View>
                                            </View>
                                            <View style={[mr10]}>
                                               <Text style={commonStyles.h14blackOne600}>Purchase No</Text>
                                                <View style={[{ height: 40, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]}>{invoiceDetails.purchaseId}</Text>
                                                </View>
                                            </View>
                                        </View>
                                        <View style={[flexRow, justifyBetween, alignItemCenter, mt15]}>
                                            <View style={[ml10]}>
                                               <Text style={commonStyles.h14blackOne600}>Purchases To</Text>
                                                <View style={[{ height: 60, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]} >{invoiceDetails.vendorId.vendor_name ?? "N/A"}</Text>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]} >{invoiceDetails?.vendorId?.vendor_email ?? "N/A"}</Text>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]} >{invoiceDetails?.vendorId?.vendor_phone ?? "N/A"}</Text>
                                                </View>
                                            </View>
                                            <View style={[mr10]}>
                                               <Text style={commonStyles.h14blackOne600}>Pay To</Text>
                                                <View style={[{ height: 60, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]}>KanakkuLLC{'\n'}Brooklyn, NY 333{'\n'}USA</Text>
                                                </View>
                                            </View>
                                        </View>
                                    </View>

...
interface QuotationDetailsScreen {
    _id: string;
    quotation_id: string;
...
const QuotationDetailsScreen = ({ route }: any) => {
    // Extract invoiceDetails from route.params
    const [invoiceDetails, setViewDetailsData] = useState<QuotationDetailsScreen | null>(null);
    ...
    const ViewPurchaseData = () => {
        try {
            getMethod(
                ApiUrl.viewQuotation + route.params.itemId,
                success => {
                    if (success.code === 200) {
            ...
            <SafeAreaView style={getMainContainerStyle(false)}>
                <View style={[flex1]}>
                    <View style={[mh15, mv10]}>
                        <TopHeader headerText={labels.quotationDetails} />
                    </View>
                                            ...
                                            <View style={[ml10]}>
                                               <Text style={commonStyles.h14blackOne600}>Date</Text>
                                                <View style={[{ height: 40, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]} >{moment(invoiceDetails.quotation_date).format('DD MMM YYYY')}</Text>
                                                </View>
                                            </View>
                                            <View style={[mr10]}>
                                               <Text style={commonStyles.h14blackOne600}>Quotation No</Text>
                                                <View style={[{ height: 40, width: DevWidth / 2.3, backgroundColor: colors.greyOne, borderRadius: 5 }, alignItemStart, justifyCenter, mt5]}>
                                                    <Text style={[commonStyles.h12blackTwo400,ml10]} >{invoiceDetails.quotation_id}</Text>
                                                </View>
                                            </View>
                                        </View>
                                        ...
                                        <View style={[flexRow, alignItemCenter, justifyBetween, mh10]}>
                                            ...
                                            <View style={[{
                                                ...
                                                <View style={{ width: '100%' }}>
                                                    <Text style={[commonStyles.h12blackTwo400]} >KanakkuLLC{'\n'}Brooklyn, NY 333{'\n'}USA</Text>

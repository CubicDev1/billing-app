...
const PurchasesTaxReport = (props: PurchaseReportProps) => {
    ...
    return (
        <View style={[{ backgroundColor: colors.whiteTwo }]}>
            <View style={{ marginBottom: 425 }}>
                <ListSubHeader listName={labels.purchase} totalNumber={total} onFilterPress={openFilterModal} />
                <FlatList
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                                        <View style={{ flexDirection: 'row' }}>
                                            <View style={{ alignSelf: 'center', marginHorizontal: 8 }}>
                                               <Text style={[commonStyles.h10Primary600]}>{report.purchaseId}</Text>
                                                 <Text style ={[commonStyles.h15blackOne600]}>{report.vendorId?.vendor_name}</Text>
                                            </View>
                                        </View>
                                    ...
                                    <View style={{ backgroundColor: colors.white4, padding: 10, borderRadius: 10 }}>
                                        <View style={[flexRow, justifyBetween]}>
                                            ...
                                            <View>
                                               ...
                                               <Text style={commonStyles.h14blackOne600}>{currencySymbol}{parseFloat(report?.vat ?? '0')}</Text>
                                            </View>
                                            {/* <View>
...
export default PurchasesTaxReport;
